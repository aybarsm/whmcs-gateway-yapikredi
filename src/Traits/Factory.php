...
namespace Aybarsm\Whmcs\Gateway\Yapikredi\Traits;
...
trait Factory
{
    ...
    protected static function makeValidationFactory(): \Illuminate\Validation\Factory
    {
        ...
        $factory->extend('valid_xid', function ($attribute, $value, $parameters, \Illuminate\Validation\Validator $validator) {
            $invoiceId = \Aybarsm\Whmcs\Gateway\Yapikredi\Posnet::getInvoiceIdByXid($value);
            ...
            $paymentMethod = \Aybarsm\Whmcs\Gateway\Yapikredi\Posnet::getIdentifier();
